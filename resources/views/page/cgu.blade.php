<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="flex-1 font-semibold text-xl text-sky-500">
            {{ __('Conditions Générales d\'Utilisation') }}
        </h2>
    </x-slot>

    <div class="m-6 p-6 py-4 bg-white">
        <article class="prose-sm md:prose max-w-none">
            
            <p><b>En vigueur au 03/07/2022</b></p>
            
            <p>Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique des modalités de mise à disposition du site et des services par le site <i class="font-bold text-coral">"Easy味" - ezaj.jp</i> et de définir les conditions d’accès et d’utilisation des services par « l'Utilisateur ».</p>
            <p>Les présentes CGU sont accessibles sur le site à la rubrique «Conditions Générales d'Utilisation».</p>
            ...
            <i class="font-bold text-coral">Easy味</i>  se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes CGU.</p>
            
            <h2>Article 1 : Les mentions légales</h2>
            
            <p>L’édition et la direction de la publication du site <i class="font-bold text-coral">Easy味</i> est assurée par les membres de sa communauté.
            
            <h4>Contact</h4>
            <p class="text-center">
                Ludovic Brient<br/>
                <a href="mailto:contact@ezaj.jp" class="text-coral font-bold">contact@ezaj.jp</a>
            </p>
            
            <h4>Hébergement</h4>
            <p>Le site <i class="font-bold text-coral">Easy味</i> est hébergé par <b>TODO</b>, dont le siège social est situé au <b>TODO</b>, avec le numéro de téléphone : <b>TODO</b>.</p>
            
            <h2>Article 2 : Accès au site</h2>
            
            <p>Le site <i class="font-bold text-coral">Easy味</i>  permet à l'Utilisateur un accès gratuit aux services suivants :
            Le site internet propose les services suivants :
            - Création et partage de recettes de cuisine
            - Gestion de recettes favorites
            - Gestion de menu hebdomadaire et mensuel
            ...
            Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du site ou serveur et sous réserve de toute interruption ou modification en cas de maintenance, n'engage pas la responsabilité de <i class="font-bold text-coral">Easy味</i>. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à l’éditeur de toute interruption ou suspension de service, même sans préavis.
            ...
            <p>Les sources des informations diffusées sur le site <i class="font-bold text-coral">Easy味</i> sont réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.
            Les informations communiquées sont présentées à titre indicatif et général sans valeur contractuelle. Malgré des mises à jour régulières, le site <i class="font-bold text-coral">Easy味</i> ne peut être tenu responsable de la modification des dispositions administratives et juridiques survenant après la publication. De même, le site ne peut être tenue responsable de l’utilisation et de l’interprétation de l’information contenue dans ce site.
            ...
            Le site <i class="font-bold text-coral">Easy味</i> ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de ce site.
            ...
            <p>Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces liens, il sortira du site <i class="font-bold text-coral">Easy味</i>. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.</p>
            ...
            Les cookies sont de petits fichiers stockés temporairement sur le disque dur de l’ordinateur de l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site <i class="font-bold text-coral">Easy味</i>. Les cookies ne contiennent pas d’information personnelle et ne peuvent pas être utilisés pour identifier quelqu’un. Un cookie contient un identifiant unique, généré aléatoirement et donc anonyme. Certains cookies expirent à la fin de la visite de l’Utilisateur, d’autres restent.
            L’information contenue dans les cookies est utilisée pour améliorer le site <i class="font-bold text-coral">Easy味</i>.
            ...
            <h2>Législation française</h1>
            <h3>Droit d'accès au fichier informatisé</h3>
            ...
            <p class="text-center text-sm"><i>CGU réalisées sur <a href="http://legalplace.fr/" class="text-coral">Légalplace.fr</a></i></p>
        </article>
    </div>
